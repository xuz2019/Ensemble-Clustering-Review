...
- `citationKey`: `hadjitodorov2006moderate`
- `category`: `Ensemble weighting methods`
- `venue`: Information Fusion
- `year`: 2006
- `paper`: https://doi.org/10.1016/j.inffus.2005.01.008
...
- Original local folder: `Experiment\(5) Moderate diversity for better cluster ensembles`
