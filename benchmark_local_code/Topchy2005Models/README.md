...
- `citationKey`: `Topchy2005Models`
- `category`: `Probabilistic methods`
- `venue`: IEEE TPAMI
- `year`: 2005
- `paper`: https://doi.org/10.1109/tpami.2005.237
...
- Original local folder: `Experiment\(1) Clustering_ensembles_models_of_consensus_and_weak_partitions`
